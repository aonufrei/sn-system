...
public class UserProfileRestController {
	...
	public ProfileDto getProfileById(@Parameter(description = "Id of the requested profile") @PathVariable Long id) {
		return profileService.getById(id);
	}

	@GetMapping("/account/{id}")
	@Operation(summary = "Get Profile by account", description = "Returns profile by related account id")
	public ProfileDto getProfileByAccount(@Parameter(description = "Id of the account related to the profile") @PathVariable("id") Long id) {
...
//	}
	...
	public Boolean updateProfile(@Parameter(name = "Profile id", description = "The id of the profile you want to update") @PathVariable Long id,
			@Parameter(description = "Profile that you want to add") @RequestBody ProfileInDto profile) {
		return profileService.update(id, profile);
	}

	@DeleteMapping("/{id}")
	@Operation(summary = "Delete profile", description = "Deletes profile by id")
	public Boolean deleteProfile(@Parameter(description = "Id of the profile you want to delete") @PathVariable Long id) {
